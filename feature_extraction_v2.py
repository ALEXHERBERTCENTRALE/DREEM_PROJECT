...
def extractFeatureAll(h5file_freq , methodOne ,  list_bool_extract_signal , list_param_extract_signal):
...
def extractMultiFeatureAll(h5file_freq , list_methodOne , mat_bool_extract_signal , mat_param_extract_signal , save = False , name_save = None):
    ...
    for methodOne in list_methodOne :
        ...
        rep[:,c:c+temp] = extractFeatureAll(h5file_freq , methodOne , mat_bool_extract_signal[i] , mat_param_extract_signal[i] )
        i+=1
        c+=temp
...
print(extractMultiFeatureAll(dico , [nbPikesOne , methodTestOne ]  , mat_bool_test , mat_param_test[0:2]))
print(extractMultiFeatureAll(dico , [nbPikesOne , methodTestOne , stdDeviationNbOne]  , mat_bool_test , mat_param_test))
